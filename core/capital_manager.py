...
LEVEL_1_MICRO = LevelParams(
    ...
    spread_threshold_above_fees=0.18,
    max_slippage_pct=0.25,
    min_net_profit_pct=0.25,
    min_net_profit_usdt=0.03,
...
LEVEL_2_MULTI = LevelParams(
    ...
    spread_threshold_above_fees=0.12,
...
LEVEL_3_STAT = LevelParams(
    ...
    spread_threshold_above_fees=0.10,
    max_slippage_pct=0.35,
...
LEVEL_4_MM = LevelParams(
    ...
    spread_threshold_above_fees=0.08,
    max_slippage_pct=0.30,
    min_net_profit_pct=0.10,
    min_net_profit_usdt=0.20,
    max_exposure_per_exchange_pct=30.0,
    max_exposure_per_coin_pct=15.0,
