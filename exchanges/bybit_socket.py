...
class BybitSocket:
    ...
    def runWebSockPl(self, key):
        while True:
            try:
                wss = 'wss://stream.bybit.com/v5/public/spot'  # URL для Bybit
                ...
                print(f'Установлено соединение WebSocket для ключа {key} с Bybit') 
                ...
                print(f'Разрыв соединения WebSocket для ключа {key} с Bybit')
