...
class KuCoinSocket:
    ...
    def runWebSockPl(self, key):
        while True:
            try:
                wss = 'wss://ws-api.kucoin.com/endpoint'  # URL для KuCoin
                ...
                print(f'Установлено соединение WebSocket для ключа {key} с KuCoin')  
                ...
                print(f'Разрыв соединения WebSocket для ключа {key} с KuCoin')
