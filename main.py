...
class IntegratedArbitrageBot:
    ...
    async def run(self):
        ...
        try:
            ...
            raise  # CRITICAL: re-raise so main() calls shutdown() → sell_all_to_usdt!
        except Exception as e:
    ...
    async def shutdown(self):
        ...
        if hasattr(self, 'signal_allocator') and self.signal_allocator:
            try:
                ...
                # CancelledError: second Ctrl+C during shutdown (asyncio)
                # KeyboardInterrupt: second Ctrl+C during shutdown (Python)
...
async def main():
    ...
    for attempt in range(MAX_RESTARTS + 1):
        ...
        try:
            ...
            # or run() swallows an exception, shutdown WILL be called.
            try:
                await bot.shutdown()
